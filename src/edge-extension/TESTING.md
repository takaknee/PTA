...
### 前提条件
- Microsoft Edge (最新版)
- Azure OpenAI APIまたはOpenAI APIアクセス権
- Web版OutlookまたはGmailアカウント
...
1. **Webメールサービス限定**: デスクトップ版Outlookには対応していません
2. **API制限**: Azure OpenAI/OpenAIの利用制限に依存します
