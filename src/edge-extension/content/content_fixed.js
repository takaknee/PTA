...
function createAiDialog(dialogData) {
  ...
  content.innerHTML = `
        ...
        ">
            ...
            <button onclick="closeAiDialog()" style="
                background: none;
                border: none;
                color: white;
                font-size: 24px;
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 20px;">
                ${currentService === 'outlook' || currentService === 'gmail' ? `
                    <button onclick="analyzeEmail()" style="
                        ...
                        font-weight: 500;
                    ">📧 メール解析</button>
                    <button onclick="composeReply()" style="
                    ...
                    ">📝 返信作成</button>
                ` : `
                    <button onclick="analyzePage()" style="
                        background: linear-gradient(135deg, #2196F3, #1976D2);
                        color: white;
                        border: none;
                        border-radius: 6px;
                ...
                ${dialogData.selectedText ? `
                    <button onclick="analyzeSelection()" style="
